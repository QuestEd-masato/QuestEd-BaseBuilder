...
class WeaknessDataCollector:
    ...
    def collect_comprehensive_learning_data(
        self, student_id: int, days_back: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        包括的な学習データを収集
        ...
        try:
            data = {
                ...
                "basebuilder_data": self._collect_basebuilder_data(
    ...
    def _collect_answer_records(
        self, student_id: int, start_date: datetime
    ) -> List[Dict]:
        """回答記録を収集"""
        try:
            ...
            return [
                {
                    ...
                    "problem": {
                        ...
                        "subject": r.problem.category.subject
                        if r.problem.category
                        else None,
                    }
                    if r.problem
                    else None,
    ...
    def _collect_evaluations(self, student_id: int) -> List[Dict]:
        ...
        try:
            evaluations = (
                StudentEvaluation.query.filter_by(student_id=student_id)
    ...
    def _collect_basebuilder_data(
        ...
        try:
                ...
                "category_performance": [
                    {
                        ...
                        "accuracy": (stat.correct_answers or 0) / stat.total_answers
            ...
            return {"word_proficiencies": [], "category_performance": []}
    ...
    def _get_empty_data_structure(
        ...
        return {
            ...
            "inquiry_themes": [],
            "evaluations": [],
            "basebuilder_data": {"word_proficiencies": [], "category_performance": []},
        }
