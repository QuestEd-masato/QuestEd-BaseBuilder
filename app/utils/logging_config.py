...
class SecurityAuditLogger:
    ...
    def log_ranking_access(
        self, user_id: int, ranking_type: str, scope: str, scope_id: int = None
    ):
        """ランキングアクセスを記録"""
...
def setup_logging(app):
    ...
    if not app.debug and not app.testing:
        ...
        file_handler = RotatingFileHandler(
            "logs/quested.log", maxBytes=10240000, backupCount=10  # 10MB
        )
        ...
        access_handler = RotatingFileHandler(
            "logs/access.log", maxBytes=10240000, backupCount=10
        )
