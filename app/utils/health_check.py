...
class HealthChecker:
    ...
    def _check_database(self) -> Tuple[str, str, Dict]:
        ...
        try:
            ...
            # 重要テーブルの存在確認
            required_tables = ['users', 'rankings', 'ranking_cache', 'schools', 'classes']
            existing_tables = []
    ...
    def _check_cache_system(self) -> Tuple[str, str, Dict]:
        ...
        try:
            ...
            return status, message, {
                ...
                'cache_hit_rate': max(0, (cache_count - expired_count) / max(cache_count, 1))
            }
    ...
    def _check_api_endpoints(self) -> Tuple[str, str, Dict]:
        ...
        try:
            ...
            for endpoint in critical_endpoints:
                try:
                    url = url_for(endpoint, ranking_type='total_points', _external=False)
    ...
    def _check_security_headers(self) -> Tuple[str, str, Dict]:
        ...
        try:
            ...
            security_config = {
                ...
                'session_cookie_httponly': current_app.config.get('SESSION_COOKIE_HTTPONLY', False),
                'permanent_session_lifetime': current_app.config.get('PERMANENT_SESSION_LIFETIME', 'not_set')
            }
