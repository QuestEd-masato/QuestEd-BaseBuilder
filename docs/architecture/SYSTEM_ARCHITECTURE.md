...
*📅 Last Updated: 2025-07-21 | Status: Consolidated Architecture Reference*

This document provides comprehensive architecture, Blueprint structure, and technical specifications for the QuestEd educational platform. This consolidated version combines architectural insights from multiple documentation sources.
...
### System Metrics
- **Total Modules**: 204+
- **API Endpoints**: 200+ routes across 8 major Blueprint modules
- **Database Models**: 25+ models in complex relationships
...
**🏗️ This consolidated architecture reference provides comprehensive technical specifications for QuestEd. Update this document when architectural changes occur.**